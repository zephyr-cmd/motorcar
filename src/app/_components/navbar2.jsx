// used for others except homePage
            ...
            return (
              ...
              >
                ...
                <div className="absolute w-full h-full bg-black/50">
                  ...
                  >
                    <h2 className=" text-xl sm:text-2xl pb-2 border-b-2 font-bold mb-4 font-poppins uppercase">
                      {slide.heading}
                    </h2>
                    <p className=" text-4xl md:text-5xl mb-4 sm:text-justify max-w-2xl font-exo2">
                      {slide.description}
                    </p>
